# 실전융합 팀 프로젝트
  ...
  - 요약 : 젊은 세대사이에 홈가드닝(Interior Gardening)이라는 새로운 트렌드로 자리잡고 있으며, 인기 취미로 떠오르고 있습니다. <br><br> 쑥쑥 스마트 화분은 식물이 필요한 빛과 수분 공급을 자동화 시키고 어플로 모니터링, 수동제어를 가능하게 해줍니다. 또한 성장일기, 고객센터, 커뮤니트를 제공합니다.<br><br> Web 에서는 CRUD  기능을 포함한 관리자페이지, 아임포트 결제모듈을 연동한 판매 페이지를 구현하였습니다. <br>
